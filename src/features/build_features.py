...
# ? df_temporal.info()
subset[["acc_z", "acc_z_temp_mean_ws_5", "acc_z_temp_std_ws_5"]].plot()
...
# Drop rows containing NaNs in any column EXCEPT 'duration'
# df_freq.dropna(subset=df_freq.columns.difference(["gyr_r_max_freq"]))
